...
namespace _67.Histogram
{
    internal class Histogram
    {
        static void Main(string[] args)
        {
            ...
            double counterA = 0; // < 200
            double counterB = 0; // 200 - 399
            double counterC = 0; // 400 - 599
            double counterD = 0; // 600 - 799
            double counterE = 0; // >= 800

            for(int i = 0; i < numbers; i++)
            {
                int a = int.Parse(Console.ReadLine());
                if (a < 200) { counterA++; }
                else if (a < 400) { counterB++; }
                else if (a < 600) { counterC++; }
                else if (a < 800) { counterD++; }
                else { counterE++; }
            }
            Console.WriteLine($"{counterA / numbers * 100:f2}%");
            Console.WriteLine($"{counterB / numbers * 100:f2}%");
            Console.WriteLine($"{counterC / numbers * 100:f2}%");
            Console.WriteLine($"{counterD / numbers * 100:f2}%");
            Console.WriteLine($"{counterE / numbers * 100:f2}%");
        }
    }
}
