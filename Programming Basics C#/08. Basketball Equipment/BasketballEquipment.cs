...
която изчислява какви разходи ще има Джеси, ако започне да тренира, като знаете колко е таксата за тренировки по баскетбол
...
namespace _08.Basketball_Equipment
{
    internal class BasketballEquipment
    {
        static void Main(string[] args)
        {
            ...
            double k = tax - (tax * 0.4);
            double e = k - (k * 0.2);
            double b = e / 4;
            double a = b / 5;
            Console.WriteLine(tax + k + e + a + b);
        }
    }
}
